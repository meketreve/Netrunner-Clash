...
import GameLogRow from "./game_log_table";
...
const tablesSchema = __schema({
  ...
  gameLog: __table({
    ...
    constraints: [
      { name: 'game_log_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, GameLogRow),
  player: __table({
    name: 'player',
    indexes: [
      { name: 'googleId', algorithm: 'btree', columns: [
        'googleId',
      ] },
    ...
    constraints: [
      { name: 'player_google_id_key', constraint: 'unique', columns: ['googleId'] },
...
const reducersSchema = __reducers(
  __reducerSchema("apply_buff", ApplyBuffReducer),
  __reducerSchema("attack", AttackReducer),
  __reducerSchema("complete_tutorial", CompleteTutorialReducer),
  __reducerSchema("end_phase", EndPhaseReducer),
  ...
  __reducerSchema("use_hack", UseHackReducer),
);
